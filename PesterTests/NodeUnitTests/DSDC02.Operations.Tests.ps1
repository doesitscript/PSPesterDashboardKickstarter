...
$CurrentBaseline = Import-Clixml -Path C:\OneDrive\Develop\Git\PSPesterPresentationKit.HV1\OperationalBaselines\MockSnapshots\DSDC02.Baseline.xml

#Import saved AD snapshot
$Snapshot = Import-Clixml -Path C:\OneDrive\Develop\Git\PSPesterPresentationKit.HV1\OperationalBaselines\MockBaseLines\DSDC02.Baseline.xml
