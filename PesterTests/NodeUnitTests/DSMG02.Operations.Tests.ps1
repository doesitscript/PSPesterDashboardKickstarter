...
$CurrentBaseline = Import-Clixml -Path C:\OneDrive\Develop\Git\PSPesterPresentationKit.HV1\OperationalBaselines\MockSnapshots\DSMG02.Baseline.xml

#Import saved AD snapshot
$Snapshot = Import-Clixml -Path C:\OneDrive\Develop\Git\PSPesterPresentationKit.HV1\OperationalBaselines\MockBaseLines\DSMG02.Baseline.xml
